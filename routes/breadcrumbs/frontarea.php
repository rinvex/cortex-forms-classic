...
Breadcrumbs::for('frontarea.cortex.forms.forms.index', function (Generator $breadcrumbs) {
...
Breadcrumbs::for('frontarea.cortex.forms.forms.show', function (Generator $breadcrumbs, Form $form) {
...
Breadcrumbs::for('frontarea.cortex.forms.forms.embed', function (Generator $breadcrumbs, Form $form) {
    $breadcrumbs->parent('frontarea.cortex.forms.forms.index');
